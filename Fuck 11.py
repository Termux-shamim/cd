...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Termux-shamim/cd/blob/main/Premium.txt"])
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/white.hat.EsanAhmedAbi      r"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Termux-shamim/cd/blob/main/Premium.txt').text
			if basesplit in plr:
				key = basesplit
